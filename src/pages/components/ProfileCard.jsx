...
const ProfileCard = () => {
  ...
  return (
    <div className="flex justify-center items-center pt-[10vh]">
      <div
        data-aos="zoom-in"
        className="flex flex-col justify-center items-center mb-8 gap-4 text-center border border-opacity-30 transition-colors duration-500 ease-in-out rounded-lg hover:border-opacity-100 p-6  lg:mt-15 mt-12 bg-white"
      >
        {profileData && (
          <>
            <img
